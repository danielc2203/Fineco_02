        ...
        success: function (response) {//once the request successfully process to the server side it will return result here
            ...
            if(response.length) {
	            ...
	            $.each(response, function(key,value) {
					...
					html += "<span>" + value.first_name +' '+ value.last_name + " <span class='list-email'>(" + value.email + ")</span>" + "</span>";
					html += "<span class='list-address'>" + value.address + "</span>";
					...
					html += "<div class='tools'> <a class='btn btn-outline-danger btn-borrar-tarea'><i class='fas fa-trash'></i></a> </div>"
