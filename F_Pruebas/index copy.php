...
<?php
  ...
  if ($rol == 1 or 0 ){
    //echo '<script type="text/javascript">alert("Su rol desde index es: ' . $rol . ' y su nombre es ' . $titulo . '");</script>';
  }else{
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Lista de Funcionarios - Fineco</h3>
                  ...
                  <p class='text-right'><a class='btn btn-primary active' id='btnNuevo'>Agregar </a></p>
