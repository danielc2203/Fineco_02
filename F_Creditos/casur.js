...
let iconoF = 'fa-calculator';
  ...
  const casurDiv = document.createElement('div');
  casurDiv.classList.add('col-sm-4'); // 2. Agregar la clase "col-sm-4"
  casurDiv.classList.add('small-box', 'bg-maroon', 'text-center'); // 3. Agregar la clase "small-box bg-maroon text-center"
  casurDiv.id = "casur";// 4. Agregar el id "casur"
  ...
  a.appendChild(icon2);
  casurDiv.appendChild(innerDiv);// 8. Agregar los elementos creados a su respectivo padre
  casurDiv.appendChild(iconDiv);
  casurDiv.appendChild(a);
