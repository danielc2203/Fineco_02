...
//         var deducidos = (C2 + C4 + C6 + C8 + C10 + C12 + C14 + C16 + C18 );
//         //deducidos = Math.floor(deducidos);
//         var maximo = (devengados - C2 - C3 - C4 - C5 ) / 2;
//         //payment = (pension / 12 * asignacion) / (1 - Math.pow((1 + pension / 12),(-BonAsFam)));
//         var cupo = (maximo - C6 - C8 - C10 - C12 - C14 - C16 - C18);
  ...
  if (valorG) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        html += '<div class="col-sm-3">'
        html += '<input type="number"  id="plazo" value="" class="form-control form-control-sm" placeholder="365" required>'
        html += '</div>'
        ...
        html += '<div class="col-sm-3">'
        html += '<input type="number" id="montoCredito" value="" class="form-control form-control-sm" placeholder="$" required>'
        html += '</div>'
