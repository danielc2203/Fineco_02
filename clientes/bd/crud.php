...
$documento = (isset($_POST['num_documento'])) ? $_POST['num_documento'] : '';
...
switch($opcion){
    case 1:
        ...
        VALUES('$pnombre', '$snombre', '$papellido', '$sapellido', '$tipo', '$documento', '$correo', '$telefono', '$estado', '$ocupacion','$empresa', '$fecha') ";			
        ...
        break;    
    case 2:        
        $consulta = "UPDATE clientes SET primer_nombre='$pnombre', segundo_nombre='$snombre', primer_apellido='$papellido', segundo_apellido='$sapellido', tipo_documento='$tipo', num_documento='$documento', correo_electronico='$correo', telefono='$telefono', estado='$estado', ocupacion='$ocupacion', empresa='$empresa', fecha_incorporacion='$fecha' WHERE id='$id' ";		
        $resultado = $conexion->prepare($consulta);
        $resultado->execute();        
